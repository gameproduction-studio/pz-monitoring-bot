...
supporting identity. A completed gameplay action, inventory transfer, or container event marks
...
- `live/chatgpt_state.json` (compact v2 gameplay facts, limited to owned scope);
